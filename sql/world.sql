...
-- Dumping structure for table world.cities
...
CREATE TABLE IF NOT EXISTS `cities` (
  ...
  `created_at` timestamp NOT NULL DEFAULT '2014-01-01 03:31:01',
...
) ENGINE=InnoDB AUTO_INCREMENT=150106 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;

-- Data exporting was unselected.

-- Dumping structure for table world.countries
...
-- Dumping structure for table world.failed_jobs
...
-- Dumping structure for table world.migrations
...
-- Dumping structure for table world.password_resets
...
-- Dumping structure for table world.personal_access_tokens
...
-- Dumping structure for table world.states
...
) ENGINE=InnoDB AUTO_INCREMENT=5089 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=COMPACT;

-- Data exporting was unselected.

-- Dumping structure for table world.test
DROP TABLE IF EXISTS `test`;
CREATE TABLE IF NOT EXISTS `test` (
  `RegNO` int(11) DEFAULT NULL,
  `name` varchar(50) DEFAULT NULL,
  `Gender` char(40) DEFAULT NULL,
  `Amount` double(4,3) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Data exporting was unselected.

-- Dumping structure for table world.users
